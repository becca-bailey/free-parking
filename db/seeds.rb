...
25.times do
  ...
  Game.create(name: Faker::App.name, creator_id: counter, image_url: 'http://placekitten.com/200/200', description: Faker::Hacker.adjective, info_link: Faker::Internet.url, min_players: (rand(3)+ 1), max_players: (rand(10) + 1))
  counter += 1
end
